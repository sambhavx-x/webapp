...
const Form = () => {
	...
	const submitHandler = async (e: { preventDefault: () => void; }) => {
		...
		const travelResponse = await fetch("https://us-central1-tride-66c25.cloudfunctions.net/travel/post", {
			method: "POST",
				...
				<div className="m-5 p-5 flex item-center justify-center">
					<form action=""
						...
						<input
							...
							required
							type="date"
							className="w-2/3 ml-auto mr-auto rounded-lg mt-10 mb-10 h-16"></input>
						<input
							id="FromTime"
							placeholder="time"
							...
							required
							type="time"
							className="w-2/3 ml-auto mr-auto rounded-lg mb-5 h-16"></input>
						<input
							id="ToTime"
							placeholder="time"
